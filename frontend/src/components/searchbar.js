...
<nav
  class="block w-full max-w-screen-xl px-4 py-3 mx-auto border-x border-y text-white shadow-md rounded-xl bg-gradient-to-tr from-blue-gray-900 to-blue-gray-800">
  <div class="flex flex-wrap items-center justify-between text-white gap-y-4">
    ...
    <div class="relative flex w-full gap-2 md:w-max">
      ...
      <button
        class="!absolute right-1 top-1 select-none rounded text-black bg-white py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-blue-gray-900 shadow-md shadow-blue-gray-500/10 transition-all hover:shadow-lg hover:shadow-blue-gray-500/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="button">
        Search
      </button>
    </div>
